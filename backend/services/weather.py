...
DESTINATION_COORDS: dict[str, tuple[float, float, int | None, str]] = {
    ...
    "everest view": (27.8200, 86.7100, 3880, "Everest View area"),
    "three passes": (27.9600, 86.8100, 5535, "Everest Three Passes area"),
    "gokyo": (27.9539, 86.6946, 5357, "Gokyo Lakes"),
    ...
    "mera peak": (27.7000, 86.9000, 6476, "Mera Peak area"),
    "island peak": (27.9200, 86.9300, 6189, "Island Peak area"),
    ...
    "upper mustang": (29.1800, 83.9700, 3840, "Upper Mustang / Lo Manthang"),
    "saribung": (29.1000, 84.2000, 6000, "Saribung Pass area"),
    "mustang": (28.9200, 83.8700, 3500, "Mustang area"),
    "muktinath": (28.8167, 83.8717, 3800, "Muktinath"),
    "jomsom": (28.7800, 83.7300, 2700, "Jomsom"),
    "dhaulagiri": (28.7000, 83.5000, 5360, "Dhaulagiri region"),
    ...
    "langtang": (28.2150, 85.5200, 3870, "Langtang / Kyanjin area"),
    "gosainkunda": (28.0500, 85.4200, 4380, "Gosainkunda"),
    "helambu": (28.0000, 85.5200, 3640, "Helambu"),
    "tamang heritage": (28.1500, 85.3500, 2600, "Tamang Heritage Trail"),
    "ganja la": (28.1500, 85.5800, 5122, "Ganja La area"),
    "ruby valley": (28.2000, 85.1000, 3830, "Ruby Valley / Ganesh Himal"),
    "ganesh": (28.2000, 85.1000, 3830, "Ganesh Himal"),
    "panch pokhari": (28.0400, 85.7000, 4100, "Panch Pokhari"),
    "manaslu": (28.5500, 84.5600, 3800, "Manaslu region (approx.)"),
    "larkya": (28.5500, 84.5600, 5106, "Larkya La area"),
    "tsum": (28.6300, 85.0000, 3700, "Tsum Valley"),
    "makalu": (27.7500, 87.2000, 4870, "Makalu Base Camp area"),
    "kanchenjunga": (27.7000, 88.0000, 5143, "Kanchenjunga region"),
    "lumba sumba": (27.6500, 87.6000, 5177, "Lumba Sumba Pass area"),
    ...
    "shivapuri": (27.8100, 85.3800, 2732, "Shivapuri"),
