...
const CACHE_KEY = 'trekpal_map_locations_v1';
        ...
        <PageContainer className="pb-16">
            ...
            {isLoading ? (
                ...
                <EmptyState
                    ...
                    description="Seeded map locations will appear here after the database migration."
                />
            ) : (
                        ...
                        <Card className="p-5">
                            ...
                            {selected ? (
                                ...
                                <p className="mt-3 text-sm text-[var(--muted)]">
                                    Click a marker to see elevation and details.
                                </p>
                            )}
                        </Card>
